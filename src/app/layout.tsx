...
export const metadata: Metadata = {
  title: "TechVision - Custom Software Development for Startups",
  description: "Build scalable software solutions with TechVision. Web, mobile, and cloud development services for startups and enterprises.",
  keywords: "software development, web development, mobile apps, custom software, startup development, tech solutions",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "TechVision - Custom Software Development",
    description: "Transform your ideas into digital reality with expert software development services",
    siteName: "TechVision",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "TechVision - Software Development for Startups",
    description: "Build scalable software solutions. From concept to deployment."
  }
};
